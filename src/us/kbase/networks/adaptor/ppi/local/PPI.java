...
/**
   ...
   <pre>
   Version 2.0.2, 1/16/13 - sets c3p0 options to avoid SQL timeouts
...
public class PPI {
    ...
    /**
     get local property, or null if not defined. These are stored in
     ppi.properties
     */
	...
	if (cpds == null) {
		...
		for (int i = 0; i < url.length; i++) {
			...
			cpds.setIdleConnectionTestPeriod(240);
    ...
    /**
     make another Statement that returns results one row at a time,
    ...
    /**
     make a PreparedStatement w/ optional autogenerated keys, or null if an
     error occurs.
     */
    final public static PreparedStatement prepareStatement(Connection con,
							   String s,
     ...
     */
    final public static void setAutoCommit(Connection con, boolean b)
	throws Exception {
	if (cpds == null)
	    return;
	con.setAutoCommit(b);
