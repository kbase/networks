...
public class NetworksClient {
    ...
    public List<DatasetSource> allDatasetSources() throws IOException, JsonClientException {
        ...
        List<List<DatasetSource>> res = caller.jsonrpcCall("Networks.all_dataset_sources", args, retType, true, false);
        return res.get(0);
    }
    ...
    public List<String> allNetworkTypes() throws IOException, JsonClientException {
        ...
        List<List<String>> res = caller.jsonrpcCall("Networks.all_network_types", args, retType, true, false);
        return res.get(0);
    }
    ...
    public List<Dataset> datasetSource2datasets(String sourceRef) throws IOException, JsonClientException {
        ...
        args.add(sourceRef);
        TypeReference<List<List<Dataset>>> retType = new TypeReference<List<List<Dataset>>>() {};
        List<List<Dataset>> res = caller.jsonrpcCall("Networks.dataset_source2datasets", args, retType, true, false);
        return res.get(0);
    }
    ...
    public List<Dataset> taxon2datasets(String taxid) throws IOException, JsonClientException {
        ...
        args.add(taxid);
        TypeReference<List<List<Dataset>>> retType = new TypeReference<List<List<Dataset>>>() {};
        List<List<Dataset>> res = caller.jsonrpcCall("Networks.taxon2datasets", args, retType, true, false);
        return res.get(0);
    }
    ...
    public List<Dataset> networkType2datasets(String netType) throws IOException, JsonClientException {
        ...
        args.add(netType);
        TypeReference<List<List<Dataset>>> retType = new TypeReference<List<List<Dataset>>>() {};
        List<List<Dataset>> res = caller.jsonrpcCall("Networks.network_type2datasets", args, retType, true, false);
        return res.get(0);
    }
    ...
    public List<Dataset> entity2datasets(String entityId) throws IOException, JsonClientException {
        ...
        args.add(entityId);
        TypeReference<List<List<Dataset>>> retType = new TypeReference<List<List<Dataset>>>() {};
        List<List<Dataset>> res = caller.jsonrpcCall("Networks.entity2datasets", args, retType, true, false);
        return res.get(0);
    }
