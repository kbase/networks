...
public class CDMIAdaptorTest {

	static Adaptor adaptor;
	
	final Taxon taxon = new Taxon("kb|g.3899");
	
	final String datasetId = "kb|g.3899.nds.12";
	final String badDatasetId = "kb|g.3899.nds.abcd";

	final String geneId = "kb|g.3899.CDS.69528";
	final String clusterId = "kb|g.3899.nds.12.edge.93313";
	...
	final String dataSourceName = "POPNET";
	final String networkTypeName = "FUNCTIONAL_ASSOCIATION";
