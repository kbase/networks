...
=head1 buildInternalNetwork

Example:

    buildInternalNetwork [arguments] < input > output
...
This script is a wrapper for the CDMI-API call buildInternalNetwork. It is documented as follows:
...
my $usage = "Usage: $0 [--host=140.221.92.222:7064] dataset_ids edge_types < ids\n";
