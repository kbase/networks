...
=head1 buildFirstNeighborNetworkLimtedByStrength

Example:

    buildFirstNeighborNetworkLimtedByStrength [arguments] < input > output
...
This script is a wrapper for the CDMI-API call buildFirstNeighborNetworkLimtedByStrength. It is documented as follows:
...
my $usage = "Usage: $0 [--host=140.221.92.222:7064] dataset_ids edge_types cut_off < queryID\n";
