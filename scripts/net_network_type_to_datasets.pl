...
=head1 networkType2Datasets

Example:

    networkType2Datasets [arguments] < input > output
...
This script is a wrapper for the CDMI-API call networkType2Datasets. It is documented as follows:
...
my $usage = "Usage: $0 [--host=140.221.92.222:7064] < networkType\n";
