...
=head1 datasetSource2Datasets

Example:

    datasetSource2Datasets [arguments] < input > output
...
This script is a wrapper for the CDMI-API call datasetSource2Datasets. It is documented as follows:
...
<pre>
$datasetSourceRef is a DatasetSourceRef
...
my $usage = "Usage: $0 [--host=140.221.92.222:7064] < datasourceID\n";
